...
def create_class_weight(mu=1):
    ...
    labels_dict = {0: 12885, 1: 85572, 2: 1022,
                   3: 1150, 4: 174, 5: 1823, 6: 353}
...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    avg_fscore1 = round(f1_score(labels, preds, sample_weight=masks,
                                 average='micro', labels=[0, 2, 3, 4, 5, 6])*100, 2)
    avg_fscore2 = round(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rec-dropout', type=float, default=0.3,
